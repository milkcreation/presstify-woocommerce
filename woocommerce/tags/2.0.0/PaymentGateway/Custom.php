    ...
    public function init_form_fields()
    {
        $this->form_fields = array(
            ...
            'title' => array(
                'title'         => __( 'Titre', 'tify' ),
                'type'          => 'text',
                'description'   => __( 'Détermine le titre du moyen de paiement que les clients verront sur la page de commande.', 'tify' ),
            ...
            'description' => array(
                ...
                'type'          => 'textarea',
                'description'  => __( 'Détails sur le moyen de paiement, visible par le client sur la page de commande, lorsqu\'il choisi cette méthode.', 'tify' ),
                'default'       => '',
                'desc_tip'      => true               
            )
        );
